...
return [
    ...
    'label' => 'Ներմուծում :label',

    'modal' => [

        'heading' => 'Ներմուծում :label',
        ...
        'form' => [
            ...
            'file' => [
                ...
                'rules' => [
                    'duplicate_columns' => '{0} ֆայլը չպետք է պարունակի մեկից ավելի դատարկ սյունակի վերնագիր։ |{1,*} ֆայլը չպետք է պարունակի կրկնօրինակ սյունակի վերնագրեր։ :columns.',
                ],
        ...
        'actions' => [
            ...
            'download_example' => [
                'label' => 'Ներբեռնեք CSV ֆայլի օրինակ',
            ],
        ...
        'completed' => [
            ...
            'actions' => [
                ...
                'download_failed_rows_csv' => [
                    'label' => 'Վերբեռնեք սխալի տողի տեղեկատվությունը / վերբեռնեք սխալի տողի տեղեկատվությունը',
                ],
    ...
    'failure_csv' => [
        ...
        'error_header' => 'սխալ',
        'system_error' => 'Համակարգի սխալ, խնդրում ենք կապվել հաճախորդների սպասարկման կենտրոնի հետ։',
